<template>
  <section>
    <p class="mb-2 text-center">
      Hi! I'm Logan, an aspiring Software Developer at The Ohio State University.
    </p>
    <h1 class="text-2xl mb-2">About Me</h1>
    <p class="indent-8 mb-2">
      I have had a fascination with computers for as long as I can remember, and knew that what I would do when I grew
      up would involve them in some way. Over the course of high school, I was exposed to web development through an
      internship opportunity that allowed for me to grow both as a person and professionally. From here, I have worked
