<template>
  <section>
    ...
    <h2 class="text-xl mb-2">Academic Projects</h2>
    <p class="text-sm text-gray-500 mb-2">
      Note: to avoid potential academic misconduct by sharing the code for these project publicly, I do not have them
      linked here. In addition to this, the section is currently in-progress, and does not yet have the full description
    ...
    <h3 class="text-md mb-2">Class: CSE 3901 – Project: Web Applications</h3>
    <p>
      A program that will scrape the data from the Ohio State academic calendar, then determine if any breaks or events
